 ...
 * PARAMS : ?id_customer, ?id_offer, ?service_date, ?status, ?amount, ?payement_date
 * AUTH: token matching id_customer OR admin token OR token matching id_provider
 * RETURN: array [... {id_service, id_customer, id_offer, service_date, status, amount, payment_date, payment_method, payment_reference, created_at, updated_at}]	
 * 
 */
