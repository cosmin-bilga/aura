    ...
    <section className={contentClassName}>
      ...
      {selectedOffer && isSelectable && (
        <aside className="service-detail">
          ...
          {(() => {
            const detailCta =
              typeof getDetailCta === "function"
                ? getDetailCta(selectedOffer)
                : null;
            const label =
              (detailCta && detailCta.label) || "Demander ce service";
            const disabled = Boolean(detailCta && detailCta.disabled);
            const handler =
              detailCta && detailCta.onClick
                ? () => detailCta.onClick(selectedOffer)
                : undefined;
            return (
              <button
                type="button"
